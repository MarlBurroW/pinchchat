...
const en = {
  ...
  'session.copyLinkFailed': 'Could not copy link',
  ...
  'sidebar.selectAgent': 'Select agent',
  'sidebar.emptyTitle': 'No sessions yet',
  'sidebar.emptySubtitle': 'Start by creating a new session',
...
const fr: Record<keyof typeof en, string> = {
  ...
  'sidebar.copyLink': 'Copier le lien',
  'session.linkCopied': 'Lien copié !',
  'session.notFound': 'Session introuvable',
  'session.copyLinkFailed': 'Impossible de copier le lien',
  ...
  'sidebar.filterFavorites': 'Favoris',
  'sidebar.favorite': 'Favori',
  'sidebar.unfavorite': 'Retirer des favoris',
  'sidebar.filterAllAgents': 'Tous les agents',
  'sidebar.newSession': 'Nouvelle session',
  'sidebar.selectAgent': 'Sélectionner un agent',
  'sidebar.emptyTitle': 'Aucune session',
  'sidebar.emptySubtitle': 'Commencez par créer une nouvelle session',
...
const es: Record<keyof typeof en, string> = {
  ...
  'sidebar.copyLink': 'Copiar enlace',
  'session.linkCopied': '¡Enlace copiado!',
  'session.notFound': 'Sesión no encontrada',
  'session.copyLinkFailed': 'No se pudo copiar el enlace',
  ...
  'sidebar.filterFavorites': 'Favoritos',
  'sidebar.favorite': 'Favorito',
  'sidebar.unfavorite': 'Quitar de favoritos',
  'sidebar.filterAllAgents': 'Todos los agentes',
  'sidebar.newSession': 'Nueva sesión',
  'sidebar.selectAgent': 'Seleccionar agente',
  'sidebar.emptyTitle': 'Sin sesiones',
  'sidebar.emptySubtitle': 'Comience creando una nueva sesión',
...
const de: Record<keyof typeof en, string> = {
  ...
  'session.copyLinkFailed': 'Link konnte nicht kopiert werden',
  'sidebar.close': 'Seitenleiste schließen',
  'sidebar.clearSearch': 'Suche leeren',
  'sidebar.filterAll': 'Alle',
  'sidebar.filterActive': 'Aktive',
  'sidebar.filterFavorites': 'Favoriten',
  'sidebar.favorite': 'Favorit',
  'sidebar.unfavorite': 'Entfernen',
  'sidebar.filterAllAgents': 'Alle Agenten',
  'sidebar.newSession': 'Neue Sitzung',
  'sidebar.selectAgent': 'Agent auswählen',
  'sidebar.emptyTitle': 'Keine Sitzungen',
  'sidebar.emptySubtitle': 'Erstellen Sie eine neue Sitzung',
...
const ja: Record<keyof typeof en, string> = {
  ...
  'session.linkCopied': 'リンクをコピーしました！',
  'session.notFound': 'セッションが見つかりません',
  'session.copyLinkFailed': 'リンクをコピーできませんでした',
  'sidebar.close': 'サイドバーを閉じる',
  'sidebar.clearSearch': '検索をクリア',
  'sidebar.filterAll': 'すべて',
  'sidebar.filterActive': 'アクティブ',
  'sidebar.filterFavorites': 'お気に入り',
  'sidebar.favorite': 'お気に入り',
  'sidebar.unfavorite': 'お気に入り解除',
  'sidebar.filterAllAgents': 'すべてのエージェント',
  'sidebar.newSession': '新しいセッション',
  'sidebar.selectAgent': 'エージェントを選択',
  'sidebar.emptyTitle': 'セッションなし',
  'sidebar.emptySubtitle': '新しいセッションを作成してください',
...
const pt: Record<keyof typeof en, string> = {
  ...
  'sidebar.copyLink': 'Copiar link',
  'session.linkCopied': 'Link copiado!',
  'session.notFound': 'Sessão não encontrada',
  'session.copyLinkFailed': 'Não foi possível copiar o link',
  ...
  'sidebar.filterFavorites': 'Favoritos',
  'sidebar.favorite': 'Favorito',
  'sidebar.unfavorite': 'Remover dos favoritos',
  'sidebar.filterAllAgents': 'Todos os agentes',
  'sidebar.newSession': 'Nova sessão',
  'sidebar.selectAgent': 'Selecionar agente',
  'sidebar.emptyTitle': 'Sem sessões',
  'sidebar.emptySubtitle': 'Comece criando uma nova sessão',
...
const zh: Record<keyof typeof en, string> = {
  ...
  'session.copyLinkFailed': '无法复制链接',
  'sidebar.close': '关闭侧边栏',
  'sidebar.clearSearch': '清除搜索',
  'sidebar.filterAll': '全部',
  'sidebar.filterActive': '活跃',
  'sidebar.filterFavorites': '收藏',
  'sidebar.favorite': '收藏',
  'sidebar.unfavorite': '取消收藏',
  'sidebar.filterAllAgents': '所有代理',
  'sidebar.newSession': '新建会话',
  'sidebar.selectAgent': '选择代理',
  'sidebar.emptyTitle': '暂无会话',
  'sidebar.emptySubtitle': '开始创建新会话',
  'split.close': '关闭分屏',
  'app.mainChat': '主聊天',
  'app.splitPane': '分屏面板',
...
const it: Record<keyof typeof en, string> = {
  ...
  'session.copyLinkFailed': 'Impossibile copiare il link',
  ...
  'sidebar.filterFavorites': 'Preferiti',
  'sidebar.favorite': 'Preferito',
  'sidebar.unfavorite': 'Rimuovi dai preferiti',
  'sidebar.filterAllAgents': 'Tutti gli agenti',
  'sidebar.newSession': 'Nuova sessione',
  'sidebar.selectAgent': 'Seleziona agente',
  'sidebar.emptyTitle': 'Nessuna sessione',
  'sidebar.emptySubtitle': 'Inizia creando una nuova sessione',
